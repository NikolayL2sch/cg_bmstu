...
def show_instruction():
    ...
    msg.setText("Смена цвета регулярного отсекателя/отрезков.\nВыбор одного из предложенных цветов меняет цвет "
                "закраски для всех существующих фигур этого типа."
                "фигур.\n\nВвод регулярного отсекателя (прямоугольника) осуществляется путем зажатий клавиш CTRL + "
                "SHIFT и тянущим движением зажатой левой кнопкой мыши."
